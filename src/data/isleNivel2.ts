...
// Vocabulario del Instituto Superior de Lenguas Extranjeras, Nivel 2
// (hotel, restaurante, fechas) -- added in 913537f. Separate from Nivel 1
// (isleNivel1.ts), which holds the vocabulary that came before it.
